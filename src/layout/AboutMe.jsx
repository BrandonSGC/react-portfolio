    ...
    <section id="about" className="py-10 bg-slate-100 dark:bg-slate-800">
      ...
      <Container className="flex flex-col grid-cols-2 gap-4 md:grid">
        ...
        <div className="my-10 space-y-5">
          ...
          <p>
            I'm an aspiring junior developer deeply passionate about
            programming, specializing in full-stack development with React.js &
            Node.js. With an insatiable hunger for learning. I Prioritize user
            experience, and writing clean, highly performant code, I am
            dedicated to honing my skills and crafting innovative React.js and
          ...
          <p>
            ...
            I delved into the world of web development. I continuously expanding
            my skill set to build innovative solutions.
          </p>
        </div>
      </Container>
    </section>
